...
- [调研报告](#%e8%b0%83%e7%a0%94%e6%8a%a5%e5%91%8a)
  ...
  - [前瞻性/重要性分析](#%e5%89%8d%e7%9e%bb%e6%80%a7%e9%87%8d%e8%a6%81%e6%80%a7%e5%88%86%e6%9e%90)
    - [更易于部署](#%e6%9b%b4%e6%98%93%e4%ba%8e%e9%83%a8%e7%bd%b2)
    - [支持多用户](#%e6%94%af%e6%8c%81%e5%a4%9a%e7%94%a8%e6%88%b7)
...
本项目旨在实现可用性高的基于互联网网页的小型分布式文件系统，在已有的项目的基础上，希望实现容器化服务器端和客户端，多用户权限管理、更高效的文件碎片传输、更低复杂度的备份机制，减轻中央服务器负担等优化，做出可用性高的“私人网盘”。
...
在我们的设计中，我们将利用所有部署了客户端的机器共享存储空间存储文件碎片，利用一个专用的中央服务器维持系统的状态并协调各个客户机处理请求，利用互联网网页访问整个文件系统。这样，只要是一个部署了客户端的机器便都可以通过贡献存储空间的方式加入分布式文件系统；只要是一个可以上网、安装了网页浏览器的电脑就都可以访问我们的分布式文件系统。这使得我们的分布式文件系统具备较为便捷的访问方式与利用闲置设备的潜力。

同时，客户端和服务器端采用容器化技术进行封装，使得部署相当便捷，无需复杂的配置即可部署客户端和服务器端。
